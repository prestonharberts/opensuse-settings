...
Paste the following into `~/.ssh/known_hosts` (create if it doesn't exist) as per [GitHub's SSH key fingerprints (GitHub)](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/githubs-ssh-key-fingerprints):
